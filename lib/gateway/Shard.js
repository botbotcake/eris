        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            case "PRESENCE_UPDATE": {
                if(packet.d.user.username !== undefined) {
                    ...
                    if(!user || oldUser) {
                        user = new User(packet.d.user, this.client);//this.client.users.update(packet.d.user, this.client);
                        /**
            ...
            case "GUILD_BAN_ADD": {
                ...
                */
                this.emit("guildBanAdd", this.client.guilds.get(packet.d.guild_id), new User(packet.d.user, this.client)/*this.client.users.update(packet.d.user, this.client)*/);
                break;
            }
            case "GUILD_BAN_REMOVE": {
                ...
                * @prop {User} user The banned user
                */
                this.emit("guildBanRemove", this.client.guilds.get(packet.d.guild_id), new User(packet.d.user, this.client)/*this.client.users.update(packet.d.user, this.client)*/);
                break;
            }
            ...
            case "CHANNEL_RECIPIENT_ADD": {
                ...
                * @prop {User} user The user
                */
                this.emit("channelRecipientAdd", channel, channel.recipients.add(new User(packet.d.user, this.client)/*this.client.users.update(packet.d.user, this.client)*/));
                break;
            }
